"""
block_dict_to_input_program.py | Author: Original source from LAX: https://github.com/cogtoolslab/lax/blob/master/stimuli/towers/block_dict_to_input_program.py
"""
